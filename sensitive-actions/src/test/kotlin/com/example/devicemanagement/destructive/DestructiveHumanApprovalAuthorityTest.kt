...
class DestructiveHumanApprovalAuthorityTest {
    ...
    fun `issued challenge is unpredictable and not a fixed magic string`() {
        ...
        assertTrue(firstIssued.response !== secondIssued.response)
    }
    ...
    fun `challenge and approval replay fail`() {
        val fixture = liveAuthority()
        val issued = fixture.issueChallenge() as DestructiveChallengeIssueResult.Issued
        val approved = fixture.redeem(issued) as DestructiveHumanApprovalResult.Approved
        assertTrue(fixture.redeem(issued) is DestructiveHumanApprovalResult.Failed)
    ...
    @Test
    fun `caller constructed challenge and response cannot mint approval`() {
        val fixture = liveAuthority()
        val forged = DestructiveOperatorChallenge.create(ByteArray(32) { 1 })
        val forgedResponse = DestructiveOperatorChallengeResponse.create()
        assertTrue(
            fixture.authority.redeem(
                challenge = forged,
    ...
    fun `reconstructed authority cannot restore approval after process death`() {
        ...
        val approved = first.redeem(issued) as DestructiveHumanApprovalResult.Approved
        ...
        assertTrue(reconstructed.redeem(issued) is DestructiveHumanApprovalResult.Failed)
    }
    ...
    fun `negative monotonic delta and stale approval fail closed`() {
        ...
        val approved = fixture.redeem(second) as DestructiveHumanApprovalResult.Approved
    ...
    fun `approval types are not persistable and production mint stays unwired`() {
        val types = listOf(
            ...
            DestructiveOperatorChallengeResponse::class.java,
    ...
    private class ApprovalFixture(
        ...
        fun redeem(issued: DestructiveChallengeIssueResult.Issued): DestructiveHumanApprovalResult {
