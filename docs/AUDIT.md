...
`APPLIED` for destruction. Simulated destructive evidence still has an
in-process log (`DestructiveEvidencePhase`) for ordering. Checkpoint 17B
...
`APPLIED`. See `docs/WIPE_17A_PREFLIGHT.md` and
