...
class DeviceManagementUiBoundaryTest {
    ...
    fun `UI cannot reference policy infrastructure or sensitive action internals`() {
        ...
        assertFalse(uiSources.contains("DestructiveArmingAuthority"))
        assertFalse(uiSources.contains("DestructiveAuthorizationAuthority"))
        assertFalse(uiSources.contains("DestructiveAttemptAdmissionAuthority"))
        assertFalse(uiSources.contains("DestructiveCapability"))
        assertFalse(uiSources.contains("FinalExecutionPermit"))
        assertFalse(uiSources.contains("SimulatedDestructiveExecutor"))
        assertFalse(uiSources.contains("Checkpoint17ASimulationSink"))
        assertFalse(uiSources.contains("DenyOnlyCooldownMarkerStore"))
        assertFalse(uiSources.contains("RuntimeDenyOnlyCooldownStore"))
        assertFalse(uiSources.contains("RuntimeDestructiveSafetyDurability"))
    ...
    fun `app production sources stay on the public controller and status providers`() {
        ...
        assertFalse(appSources.contains("DestructiveAuthorizationAuthority"))
        assertFalse(appSources.contains("DestructiveAttemptAdmissionAuthority"))
        assertFalse(appSources.contains("DestructiveCapability"))
        assertFalse(appSources.contains("FinalExecutionPermit"))
        assertFalse(appSources.contains("SimulatedDestructiveExecutor"))
        assertFalse(appSources.contains("DenyOnlyCooldownMarkerStore"))
        assertFalse(appSources.contains("RuntimeDenyOnlyCooldownStore"))
        assertFalse(appSources.contains("RuntimeDestructiveSafetyDurability"))
        assertFalse(appSources.contains("AndroidDestructiveSafetyPersistence"))
        assertFalse(appSources.contains("DestructiveArtifactIdentity"))
        assertFalse(appSources.contains("DestructiveHumanApprovalAuthority"))
